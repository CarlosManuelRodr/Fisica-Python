...
#========================================================================================
#description     : Dos osciladores acoplados con tres resortes.
...
resorte3 = helix(pos=(refX2+x2, 0, 0), axis=(refPlano2-refX2-x2,0,0), color=(128,128,128), radius=1, coils = 25, thickness=0.4)
...
labelK3 = label(display = control.display, pos = (30, -40), height = 8)
sliderK3 = slider(pos = (-40,-40), length = 50, axis = (1,0,0), width = 5, action = lambda: CambiaK3(sliderK3.value), min = 0.00, max = 10)
sliderK3.value = k3
CambiaK3(k3)
...
while True:
	...
	if m1 == 0 or m2 == 0:
		...
		vx2 += p.deltat*(-(k2/m2)*(x2-x1)-(k3/m2)*x2)
		x1 += p.deltat*vx1
		x2 += p.deltat*vx2
	...
	resorte3.axis = vector(refPlano2-refX2-x2,0,0)
