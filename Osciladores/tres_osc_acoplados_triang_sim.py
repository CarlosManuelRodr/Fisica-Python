...
while True:
    ...
    if m == 0:
        ...
        vx1 += deltat*((k/m)*(x2+x3-2*x1))
        vx2 += deltat*((k/m)*(x1+x3-2*x2))
        vx3 += deltat*((k/m)*(x2+x1-2*x3))
        vy1 += deltat*((k/m)*(y2+y3-2*y1))
        vy2 += deltat*((k/m)*(y1+y3-2*y2))
        vy3 += deltat*((k/m)*(y2+y1-2*y3))
        x1 += deltat*vx1
        x2 += deltat*vx2
        x3 += deltat*vx3
        y1 += deltat*vy1
